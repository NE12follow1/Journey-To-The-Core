class Room():
    def __init__(self,roomID):
        ...
        self.enemyPresent = [False,""]         #List = [Boolean for the existence of an enemy in the room, Object for the enemy itself]
        self.boxPresent = [False,False]        #List = [Boolean for the existence of an equipment box in the room, Boolean for whether the box is or isn't open]
